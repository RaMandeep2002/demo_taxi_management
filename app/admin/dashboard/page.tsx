...
function StatCard({ title, value, icon }: StatCardProps) {
  return (
    ...
    <motion.div
      ...
      className="relative overflow-hidden rounded-xl  dark:dark:bg-[#34363F] shadow-lg transition group hover:scale-[1.025] hover:shadow-xl duration-200"
    >
      <div className="flex flex-row items-center justify-between px-5 pt-5 pb-2">
        ...
        <div className="bg-blue-500/10 rounded-full p-2 flex items-center justify-center shadow-inner">
          <span className="text-blue-600 dark:text-[#FBE4D8] text-xl">
            {icon}
          </span>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
          <div className="space-y-2">
            <motion.h1
              ...
              className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-[#BAFB5D] tracking-wider"
            >
              Dashboard
            </motion.h1>
            <motion.p
          ...
          {iserror ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <StatCard
                ...
                icon={
                  <Car className="h-6 w-6 text-yellow-500 dark:text-yellow-400" />
                }
                // className="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700"
              />
              <StatCard
                ...
                icon={
                  <Route className="h-6 w-6 text-yellow-500 dark:text-yellow-400" />
                }
                // className="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700"
              />
              <StatCard
                ...
                icon={
                  <BookText className="h-6 w-6 text-yellow-500 dark:text-yellow-400" />
                }
                // className="bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700"
              />
            </div>
            ...
            <Card className="shadow-lg border-0 dark:bg-[#34363F] transition">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-lg font-bold">{data.bookingCount}</span>
                </div>
              </CardHeader>
            ...
            <Card className="shadow-lg border-0 dark:bg-[#34363F] transition">
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-lg font-bold">{data.driverCount}</span>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                {isLoading ? (
                        ...
                        <div className="text-right min-w-[120px] flex flex-col items-end sm:items-end sm:mt-0 mt-2">
                          ...
                          <span className="text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <span className="font-semibold text-gray-800 dark:text-gray-200">
                              {typeof driver?.totalEarnings !== "undefined"

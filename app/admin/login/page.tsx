...
export default function Login() {
  ...
  const { token, isLoading, role } = useSelector(
        ...
        toast({
          ...
          description: (
            <span style={{ color: "#991b1b" }}>
              Only <span style={{ fontWeight: "bold" }}>admins</span> can access
              this portal.
            </span>
          ),
          variant: "destructive",
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-[450px]"
      >
        <Card className="w-full shadow-2xl border-0 dark:border-0 bg-white/90 dark:bg-zinc-800/90 backdrop-blur-md transition-colors">
          <CardHeader className="flex flex-col items-center gap-2 pb-2">
            <motion.div
              ...
              className="w-16 h-16 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center mb-2 shadow-md"
            >
              <svg
                width="36"
                height="36"
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
              <div className="grid w-full items-center gap-7">
                ...
                >
                  <Label
                    htmlFor="email"
                    className="text-zinc-800 dark:text-zinc-200 font-semibold text-base"
                  >
                    Email Address
                  </Label>
                  <Input
              ...
              <CardFooter className="flex flex-col gap-3 justify-end mt-8 px-0">
                ...
                >
                  ...
                  <div className="text-center text-sm text-zinc-500 dark:text-zinc-400 mt-2">
                    ...
                    <span className="ml-1 text-blue-600 dark:text-blue-400 font-medium cursor-pointer hover:underline transition">
                      Contact Super Admin
                    </span>
                  </div>
                </motion.div>
        ...
        <div className="mt-8 text-center text-zinc-500 dark:text-zinc-400 text-xs">
          &copy; {new Date().getFullYear()} Demo Taxi Admin Portal. All rights
          reserved.
        </div>
      </motion.div>
    </div>
